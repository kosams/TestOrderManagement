...
public class TestOrder {
    ...
    public TestOrder() {
        System.out.println("### configMap test : " + configMap);
    }
    ...
    public void onPostPersist(){
        ...
        if("PLACE".equals(getState().toUpperCase())) {
            ...
            System.out.println(MessageFormat.format("$$$ JSON Published by testOrder:PLACE /{0}/{1}/{2}/{3}/", getId(), getCustomerId(), getState(), getDate()));
            System.out.println(getMenuOption());

            //Following code causes dependency to external APIs
            // it is NOT A GOOD PRACTICE. instead, Event-Policy mapping is recommended.

            System.out.println(MessageFormat.format("$$$ Request from testOrder:PLACE /{0}/{1}/{2}/{3}/", getId(), getCustomerId(), getState(), getDate()));
            ...
            // mappings goes here
            TestOrderManagementApplication.applicationContext.getBean(pizza.external.PaymentHistoryService.class)
            ...
            System.out.println(MessageFormat.format("$$$ JSON Published by testOrder:CANCEL /{0}/{1}/{2}/{3}/", getId(), getCustomerId(), getState(), getDate()));
        }
    }
